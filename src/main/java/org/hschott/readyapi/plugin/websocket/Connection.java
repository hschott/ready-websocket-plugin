...
import static org.hschott.readyapi.plugin.websocket.Utils.hexStringToBytes;
...
public class Connection implements PropertyChangeNotifier {
    ...
    public boolean equals(Object obj) {
        ...
        if (subprotocols == null) {
            return other.subprotocols == null;
        } else return subprotocols.equals(other.subprotocols);
    }
