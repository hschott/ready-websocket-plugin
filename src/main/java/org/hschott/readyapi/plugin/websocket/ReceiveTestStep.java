...
import static org.hschott.readyapi.plugin.websocket.Utils.bytesToHexString;
...
@PluginTestStep(typeName = "WebsocketReceiveTestStep", name = "Receive Websocket Message",
        ...
        iconPath = "org/hschott/readyapi/plugin/websocket/receive_step.png")
public class ReceiveTestStep extends ConnectedTestStep implements Assertable {
    ...
    protected void initIcons() {
        validStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/valid_receive_step.png");
        failedStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/invalid_receive_step.png");
        unknownStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/unknown_receive_step.png");
        disabledStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/disabled_receive_step.png");

        iconAnimator = new IconAnimator<ReceiveTestStep>(this, "org/hschott/readyapi/plugin/websocket/receive_step_base.png",
                "org/hschott/readyapi/plugin/websocket/receive_step.png", 5);
    }
