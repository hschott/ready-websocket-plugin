...
@PluginTestStep(typeName = "WebsocketOpenConnectionTestStep", name = "Open Websocket Connection",
        ...
        iconPath = "org/hschott/readyapi/plugin/websocket/rise_step.png")
public class RiseConnectionTestStep extends ConnectedTestStep {
    ...
    protected void initIcons() {
        unknownStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/unknown_rise_step.png");
        disabledStepIcon = UISupport.createImageIcon("org/hschott/readyapi/plugin/websocket/disabled_rise_step.png");

        iconAnimator = new IconAnimator<RiseConnectionTestStep>(this,
                                                                "org/hschott/readyapi/plugin/websocket/unknown_rise_step.png",
                                                                "org/hschott/readyapi/plugin/websocket/rise_step.png", 5);
    }
