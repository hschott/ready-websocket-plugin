...
public abstract class ConnectedTestStepPanel<T extends ConnectedTestStep> extends ModelItemDesktopPanel<T> {
    ...
    protected void buildTimeoutSpinEdit(SimpleBindingForm form, PresentationModel<T> pm, String label) {
        ...
        JComboBox<ConnectedTestStep.TimeMeasure> measureCombo = new JComboBox<ConnectedTestStep.TimeMeasure>(
                ConnectedTestStep.TimeMeasure.values());
        Bindings.bind(measureCombo, new SelectionInList<Object>(ConnectedTestStep.TimeMeasure.values(), pm.getModel("timeoutMeasure")));
