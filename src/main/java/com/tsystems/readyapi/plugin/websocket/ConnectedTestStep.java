...
public abstract class ConnectedTestStep extends WsdlTestStepWithProperties implements TestMonitorListener,
        ExecutableTestStep, PropertyChangeListener {
    ...
    public void testCaseFinished(TestCaseRunner runner) {
        cleanAfterExecution(runner.getRunContext());
    }
